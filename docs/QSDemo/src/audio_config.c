...
static const QS_SAMPLE_AUDIO_CAPTURE_ENTRY_PARAM_T g_sample_audio_capture_entry_param = {
...
#define SAMPLE_AO_DEFAULT_DEVICE_ID 0
...
static const QS_SAMPLE_AUDIO_PLAY_ENTRY_PARAM_T g_sample_audio_play_entry_param = {
