...
#ifndef __QS_COMMON_SYS_H__
#define __QS_COMMON_SYS_H__
...
#ifndef QS_COMM_SYS_PRT
#define QS_COMM_SYS_PRT(fmt...)   \
do {\
...
typedef struct {
    ...
    AX_U32          ubufMode;// AX_VIN_RAW_FRAME_MODE_E/AX_VIN_YUV_FRAME_MODE_E
} QS_COMMON_SYS_POOL_CFG_T;

typedef struct {
    AX_U8 nCamCnt;
    AX_U32 nPoolCfgCnt;
    QS_COMMON_SYS_POOL_CFG_T* pPoolCfg;
} QS_COMMON_SYS_ARGS_T;
