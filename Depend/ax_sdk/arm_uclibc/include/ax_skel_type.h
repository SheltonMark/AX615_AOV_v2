...
typedef enum axSKEL_PPL_E {
    ...
    AX_SKEL_PPL_FIRE,                   /* fire detection pipeline */
    AX_SKEL_PPL_FALL,                   /* fall detection pipeline */
    AX_SKEL_PPL_CROWD,                  /* crowd detection pipeline */
    AX_SKEL_PPL_PCD,                    /* pcd detection pipeline */
    AX_SKEL_PPL_PLATE,                  /* plate detection pipeline */
    AX_SKEL_PPL_MAX,
} AX_SKEL_PPL_E;
...
/// @brief active status
typedef enum axSKEL_ACTIVE_STATUS_E {
    AX_SKEL_ACTIVE_STATUS_UNKNOWN = 0,// disable stationary filter 
    AX_SKEL_ACTIVE_STATUS_NEW,
    AX_SKEL_ACTIVE_STATUS_INACTIVE,
    AX_SKEL_ACTIVE_STATUS_ACTIVE,
    AX_SKEL_ACTIVE_STATUS_MAX,
} AX_SKEL_ACTIVE_STATUS_E;

/// @brief pg status
typedef enum axSKEL_PG_STATUS_E {
    AX_SKEL_PG_STATUS_TRIG_ALARM = 0, // just triggered the alarm
    AX_SKEL_PG_STATUS_ALARM,          // is alarm status
    AX_SKEL_PG_STATUS_MAX,
} AX_SKEL_PG_STATUS_E;

/// @brief crowd direction
typedef enum axSKEL_CROWD_DIRECTION_E {
    AX_SKEL_CROWD_DIRECTION_NONE = 0, // init sts
    AX_SKEL_CROWD_DIRECTION_IN,       // crowd in
    AX_SKEL_CROWD_DIRECTION_OUT,      // crowd out
    AX_SKEL_CROWD_DIRECTION_IN_OUT,   // crowd in and out
    AX_SKEL_CROWD_DIRECTION_MAX,
} AX_SKEL_CROWD_DIRECTION_E;

/// @brief ehd alarm status
typedef enum axSKEL_EHD_ALARM_STS_E {
    AX_SKEL_EHD_ALARM_STS_OK = 0,    // no alarm
    AX_SKEL_EHD_ALARM_STS_ALARM,     // ride ebike without helmet
    AX_SKEL_EHD_ALARM_STS_MAX,
} AX_SKEL_EHD_ALARM_STS_E;

/// @brief helmet/head info
typedef struct axSKEL_EHD_ATTR_T {
    const AX_CHAR           *pstrObjectCategory;
    AX_SKEL_RECT_T           stHeadRect;
    AX_SKEL_EHD_ALARM_STS_E  eAlarmSts;
    AX_F32                   fConfidence;
} AX_SKEL_EHD_ATTR_T;

/// @brief facequality info
typedef struct axSKEL_FQ_ATTR_T {
    AX_U8 nPupilDistance;
    AX_U8 nScore;
    AX_U8 nAngle;
    AX_U8 nSharpness;
} AX_SKEL_FQ_ATTR_T;
...
typedef struct axSKEL_OBJECT_ITEM_T {
    ...
    AX_SKEL_ACTIVE_STATUS_E eActiveState;
    AX_SKEL_PG_STATUS_E ePgState;
    AX_SKEL_CROWD_DIRECTION_E eCrowdDirect;
    AX_F32 fConfidence;
    AX_BOOL bFaceAttr;
    AX_SKEL_FACE_ATTR_T stFaceAttr;
    AX_BOOL bEhdAttr;
    AX_SKEL_EHD_ATTR_T stEhdAttr;
    AX_BOOL bFqAttr;
    AX_SKEL_FQ_ATTR_T stFqAttr;
    AX_BOOL bCropFrame;
...
/// @brief rule type
typedef enum axSKEL_RULE_E {
    AX_SKEL_RULE_POLYLINE = 1,            /* polyline rule */
    AX_SKEL_RULE_POLYGON,                 /* polygon rule */
    AX_SKEL_RULE_POLYGON_WANDER,          /* polygon wander rule */
    AX_SKEL_RULE_POLYGON_FENCE,           /* polygon fence rule */
    AX_SKEL_RULE_POLYGON_ABSENCE,         /* polygon absence rule */
    AX_SKEL_RULE_POLYGON_COUNT,           /* polygon count rule */
    AX_SKEL_RULE_POLYGON_INOUT,           /* polygon inout rule */
    AX_SKEL_RULE_MAX,
} AX_SKEL_RULE_E;

/// @brief rule direction type
typedef enum axSKEL_DIRECTION_E {
    AX_SKEL_RULE_DIRECTION_IN = 1,      /* rule in */
    AX_SKEL_RULE_DIRECTION_OUT,         /* rule out */
    AX_SKEL_RULE_DIRECTION_BI,          /* rule in and out */
    AX_SKEL_RULE_DIRECTION_MAX,
} AX_SKEL_RULE_DIRECTION_E;

/// @brief rule struct
typedef struct axSKEL_RULE_CONFIG_T {
    AX_SKEL_RULE_E eRuleType;
    AX_SKEL_RULE_DIRECTION_E eDirection;
    AX_U32 nInsideDet;
    AX_U32 nPointNum;
    AX_SKEL_POINT_T *pstPoint;      // points should as clockwise or anti-clockwise
} AX_SKEL_RULE_CONFIG_T;
// cmd:"add_rule", value_type: AX_SKEL_RULE_CONFIG_T
// cmd:"delete_rule", value_type: AX_SKEL_RULE_CONFIG_T

/// @brief pg item struct
typedef struct axSKEL_PG_ITEM_T {
    AX_U64  nRuleId;
    AX_SKEL_RULE_CONFIG_T stRule;
    AX_U32 nObjectSize;
    AX_SKEL_OBJECT_ITEM_T *pstObjectItems;
} AX_SKEL_PG_ITEM_T;

typedef struct axSKEL_CROWD_INFO_T {
    AX_U32 nInNum;
    AX_U32 nOutNum;
} AX_SKEL_CROWD_INFO_T;
...
typedef struct axSKEL_RESULT_T {
    ...
    AX_U32 nPgSize;
    AX_SKEL_PG_ITEM_T *pstPgItems;
    AX_SKEL_CROWD_INFO_T stCrowdInfo;
    AX_VOID *pUserData;
    AX_VOID *pPrivate;
} AX_SKEL_RESULT_T;
...
// cmd: "push_bind_enable", value_type: AX_SKEL_COMMON_ENABLE_CONFIG_T *
// cmd: "track_enable", value_type: AX_SKEL_COMMON_ENABLE_CONFIG_T *
// cmd: "push_enable", value_type: AX_SKEL_COMMON_ENABLE_CONFIG_T *
// cmd: "push_attr_always", value_type: AX_SKEL_COMMON_ENABLE_CONFIG_T *
...
/// @brief stationary filter level
typedef enum axSKEL_STATIONARY_FILTER_LEVEL_E {
    AX_SKEL_STATIONARY_FILTER_LEVEL_U = 1,// for more slow scene
    AX_SKEL_STATIONARY_FILTER_LEVEL_T = 2,// for slow scene, default
    AX_SKEL_STATIONARY_FILTER_LEVEL_S,
    AX_SKEL_STATIONARY_FILTER_LEVEL_M,
    AX_SKEL_STATIONARY_FILTER_LEVEL_L,
    AX_SKEL_STATIONARY_FILTER_LEVEL_H,  // for fast scene 
    AX_SKEL_STATIONARY_FILTER_STRATEGY_MAX
} AX_SKEL_STATIONARY_FILTER_LEVEL_E;

/// @brief stationary filter config for body,vehicle,cycle,plate
typedef struct axSKEL_STATIONARY_FILTER_CONFIG_T {
    AX_BOOL bEnable;
    AX_SKEL_STATIONARY_FILTER_LEVEL_E level;
} AX_SKEL_STATIONARY_FILTER_CONFIG_T;

// cmd:"stationary_filter_body", value_type: AX_SKEL_STATIONARY_FILTER_CONFIG_T
// cmd:"stationary_filter_vehicle", value_type: AX_SKEL_STATIONARY_FILTER_CONFIG_T
// cmd:"stationary_filter_cycle", value_type: AX_SKEL_STATIONARY_FILTER_CONFIG_T
// cmd:"stationary_filter_plate", value_type: AX_SKEL_STATIONARY_FILTER_CONFIG_T
