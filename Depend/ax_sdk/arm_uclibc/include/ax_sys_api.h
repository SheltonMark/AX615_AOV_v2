...
typedef enum {
    AX_MOD_DATA_FLOW_MIN = 0x00,
    AX_MOD_DATA_FLOW_SW_LOW_MEM = 0x01,
    AX_MOD_DATA_FLOW_SW_LOW_LATENCY = 0x02,
    AX_MOD_DATA_FLOW_SW_OFFLINE = 0x03,
    AX_MOD_DATA_FLOW_HW_ONLINE = 0x04,
    AX_MOD_DATA_FLOW_MAX = 0x05
} AX_MOD_DATA_FLOW_MODE_E;
...
typedef enum {
    ...
    AX_ENG_DPU = 7,
    AX_ENG_MAX
} AX_ENGINE_LOWLATENCY_E;

typedef struct {
    AX_U32  nRingLineCnt;
    AX_ENGINE_LOWLATENCY_E  eSrcEngine;
    AX_ENGINE_LOWLATENCY_E  eDstEngine;
    AX_MOD_DATA_FLOW_MODE_E eDataFlowMode;
} AX_MOD_LINK_ATTR_T;
...
AX_S32 AX_SYS_GetSdkVersion(AX_CHAR *versionBuf, AX_S32 nBufSize);
...
AX_S32 AX_SYS_Link_V2(const AX_MOD_INFO_T *pSrc, const AX_MOD_INFO_T *pDest, const AX_MOD_LINK_ATTR_T *pModLinkAttr);
