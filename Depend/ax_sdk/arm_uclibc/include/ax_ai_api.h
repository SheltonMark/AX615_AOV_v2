...
#define AX_ERR_AI_FLOW_END                    AX_DEF_ERR(AX_ID_AI, AX_ID_AI_NULL, AX_ERR_FLOW_END)
#define AX_ERR_AI_ILLEGAL_PARAM               AX_DEF_ERR(AX_ID_AI, AX_ID_AI_NULL, AX_ERR_ILLEGAL_PARAM)
