...
typedef enum {
    ...
    AX_ID_ISP_NUC               = 0x29,
    AX_ID_ISP_DIS               = 0x2A,
    AX_ID_ISP_EDGE_ENHANCE      = 0x2B,
    AX_ID_ISP_HDRC              = 0x2C,
    AX_ID_ISP_HIDRC             = 0x2D,
    AX_ID_ISP_Y2DNR             = 0x2E,
    AX_ID_ISP_YCPROC            = 0x2F,
    AX_ID_ISP_BL_DET            = 0x30,
    AX_ID_ISP_IFA               = 0x31,
    AX_ID_ISP_SCM               = 0x32,
    AX_ID_ISP_CCMP              = 0x33,
    AX_ID_ISP_HS2DLUT           = 0x34,
    AX_ID_ISP_LIN               = 0x35,
    AX_ID_ISP_ACP               = 0x36,
    AX_ID_ISP_BUTT,
} AX_ISP_SUB_ID_E;
