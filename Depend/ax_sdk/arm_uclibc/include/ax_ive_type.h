...
typedef union axIVE_8BIT_U {
    AX_S16 s16Val;  /* range: [-256,255] */
    AX_U8 u8Val;    /* range: [0,255] */
} AX_IVE_8BIT_U;
...
typedef struct axIVE_ADD_CTRL_T {
    AX_S7Q8 s7q8X; /* x of "xA+yB" */
    AX_S7Q8 s7q8Y; /* y of "xA+yB" */
} AX_IVE_ADD_CTRL_T;
...
typedef struct axIVE_ORD_STAT_FILTER_BERNSEN_CTRL_T {
    ...
    AX_U8 u8Thr; /* Set to be the thresh output value. */
...
typedef struct axIVE_SAD_CTRL_T {
    ...
    AX_U8 u8MaxVal;  /* Maxmum value when tri-level thresholding */
    AX_S6Q10 as6q10Mask[25]; /* filter coefficient */
} AX_IVE_SAD_CTRL_T;
