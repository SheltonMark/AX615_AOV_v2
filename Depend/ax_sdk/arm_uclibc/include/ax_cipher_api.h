...
AX_S32 AX_CIPHER_EncryptAeadPhy(AX_CIPHER_AEAD_PHY_T *aeadPhy);
AX_S32 AX_CIPHER_DecryptAeadPhy(AX_CIPHER_AEAD_PHY_T *aeadPhy);
AX_S32 AX_CIPHER_EncryptAead(AX_CIPHER_AEAD_T *aead);
AX_S32 AX_CIPHER_DecryptAead(AX_CIPHER_AEAD_T *aead);
AX_S32 AX_CIPHER_ProvisionRandomHuk(AX_VOID);
AX_S32 AX_CIPHER_EncryptFek(AX_U8 *szSrcAddr, AX_U8 *szDestAddr, AX_U32 byteLength);
