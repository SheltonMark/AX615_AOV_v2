...
#define AX_ACODEC_PARAM_NUM     (AX_ACODEC_BAND_NUM * 3)
...
typedef struct axACODEC_EQ_EX_ATTR_T {
    AX_S32  s32GainDb[AX_ACODEC_BAND_NUM];
    AX_S32  s32EqFreq[AX_ACODEC_BAND_NUM];
    AX_F64  f64Q[AX_ACODEC_BAND_NUM];
    AX_EQ_TYPE_E  enEQType[AX_ACODEC_BAND_NUM];
    AX_S32  s32Samplerate;
    AX_BOOL bEnable;
    AX_U32  u32Reserved;
} AX_ACODEC_EQ_ATTR_EX_T;
...
AX_S32 AX_ACODEC_RxEqSetAttrEx(ACODEC_CARD acCardId, const AX_ACODEC_EQ_ATTR_EX_T *pstAttr);
AX_S32 AX_ACODEC_RxEqGetAttrEx(ACODEC_CARD acCardId, AX_ACODEC_EQ_ATTR_EX_T *pstAttr);
AX_S32 AX_ACODEC_RxEqEnableEx(ACODEC_CARD acCardId);
AX_S32 AX_ACODEC_RxEqDisableEx(ACODEC_CARD acCardId);
AX_S32 AX_ACODEC_TxEqSetAttrEx(ACODEC_CARD acCardId, const AX_ACODEC_EQ_ATTR_EX_T *pstAttr);
AX_S32 AX_ACODEC_TxEqGetAttrEx(ACODEC_CARD acCardId, AX_ACODEC_EQ_ATTR_EX_T *pstAttr);
AX_S32 AX_ACODEC_TxEqEnableEx(ACODEC_CARD acCardId);
AX_S32 AX_ACODEC_TxEqDisableEx(ACODEC_CARD acCardId);
#ifdef __cplusplus
}
#endif
