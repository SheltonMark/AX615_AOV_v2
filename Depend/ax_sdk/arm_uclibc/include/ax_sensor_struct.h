...
typedef struct _AX_SNS_ISP_I2C_DATA_T_ {
    ...
    AX_U8   bNotUpdate;         /* If 1, the register will never be updated */
...
typedef struct _AX_SENSOR_REGISTER_FUNC_T_ {
    /* sensor ctrl */
    AX_S32(*pfn_sensor_chipid)(ISP_PIPE_ID nPipeId, AX_S32 *pSnsChipId);
