...
#define DEF_ALL_MOD_GRP_MAX         (24)
#define DEF_ALL_MOD_CHN_MAX         (20)
...
/* u32CompressLevel in 8bitmode */
#define AX_COMPRESS_LEVEL_DEFAULT   (0)
#define AX_COMPRESS_Y12_5_UV12_5    (1)
#define AX_COMPRESS_Y25_UV25        (2)
#define AX_COMPRESS_Y37_5_UV37_5    (3)
#define AX_COMPRESS_Y50_UV50        (4)
#define AX_COMPRESS_Y62_5_UV62_5    (5)
#define AX_COMPRESS_Y75_UV75        (6)
#define AX_COMPRESS_Y87_5_UV87_5    (7)
#define AX_COMPRESS_Y100_UV100      (8)
#define AX_COMPRESS_Y62_5_UV50      (9)
#define AX_COMPRESS_Y75_UV50        (10)
...
typedef enum
{
    ...
    AX_FORMAT_YUV420_Y10_UV8_SEMIPLANAR_VU          = 0x5,
    ...
    AX_FORMAT_BAYER_RAW_20BPP_PACKED                = 0x88,
    ...
    AX_FORMAT_BITMAP                                = 0xE0,      /* BIT1 */
    AX_FORMAT_BITMAP_2                              = 0xE1,      /* BIT2 */
    AX_FORMAT_BITMAP_4                              = 0xE2,      /* BIT4 */
    AX_FORMAT_BITMAP_8                              = 0xE3,      /* BIT8 */
    AX_FORMAT_MAX
} AX_IMG_FORMAT_E;
...
typedef enum axAUDIO_SOUND_MODE_E {
    ...
    AX_AUDIO_SOUND_MODE_QUAD   = 2,         /*quadraphonic*/
...
typedef struct axOSD_BMP_ATTR_T {
    ...
    AX_BOOL bColorInv;          /* RW; range: [0, 1]; whether inverted color or not */
    AX_U32 u32ColorInv;         /* RW; range: [0, 0xffffff]; inverted color RGB888; 0xRRGGBB */
    AX_U16 u16ColorInvThrLo;    /* RW; range: [0, 25500]; low threshold of luma value */
    AX_U16 u16ColorInvThrHi;    /* RW; range: [0, 25500]; high threshold of luma value */
    AX_U8 u8BlkSizeHori;        /* RW; range: [0, 255]; horizontal width of block size */
    AX_U8 u8BlkSizeVert;        /* RW; range: [0, 255]; vertical height of block size */
} AX_OSD_BMP_ATTR_T;
...
typedef enum _AX_VIN_YUV_FRAME_MODE_E_ {
    AX_VIN_YUV_FRAME_NORMAL = 0,
    AX_VIN_YUV_FRAME_ROT = 1
} AX_VIN_YUV_FRAME_MODE_E;

typedef enum _AX_VIN_RAW_FRAME_MODE_E_ {
    AX_VIN_RAW_FRAME_SLICE = 0,
    AX_VIN_RAW_FRAME_BASE = 2
} AX_VIN_RAW_FRAME_MODE_E;

typedef enum _AX_VIN_RAW_SLICE_MODE_E_ {
    AX_VIN_RAW_SLICE_MOD0 = 0,
    AX_VIN_RAW_SLICE_MOD1 = 4
} AX_VIN_RAW_SLICE_MODE_E;
