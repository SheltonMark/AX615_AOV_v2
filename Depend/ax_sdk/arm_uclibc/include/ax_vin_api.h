...
typedef enum _AX_VIN_LOW_MEM_MODULE_EN_ {
    AX_VIN_LOW_MEM_DISABLE = 0,
    AX_VIN_LOW_MEM_EN_M0 = 1,
    AX_VIN_LOW_MEM_EN_M1 = 2,
    AX_VIN_LOW_MEM_EN_M2 = 4
} AX_VIN_LOW_MEM_MODULE_EN;

typedef enum _AX_VIN_LATENCY_MODE_E_ {
    AX_VIN_LATENCY_MODE_SLICE = 0,
    AX_VIN_LATENCY_MODE_FRAME = 1,
    AX_VIN_LATENCY_MODE_MAX,
} AX_VIN_LATENCY_MODE_E;
...
typedef enum _AX_VIN_DEV_WORK_MODE_E_ {
    ...
    AX_VIN_DEV_WORK_MODE_AUTO_SPLIT         = 4,
...
typedef enum _AX_VIN_CHN_ID_E_ {
    AX_VIN_CHN_ID_INVALID                = -1,
    AX_VIN_CHN_ID_MAIN                   = 0,   /* main path */
    AX_VIN_CHN_ID_MAX
} AX_VIN_CHN_ID_E;

typedef enum _AX_VIN_FUSION_MODE_E_ {
...
typedef enum _AX_VIN_DEV_IRQ_TYPE_E_ {
...
typedef enum _AX_VIN_LINE_INFO_MODE_E_ {
    AX_VIN_LI_MODE_VC                   = 0,
...
typedef enum _AX_VIN_ROTATION_E_ {
    AX_VIN_ROTATION_0   = 0,
...
typedef struct _AX_VIN_DEV_LVDS_ATTR_T_ {
    ...
    AX_U8                           nContSyncCodeMatchEn;   /* 0: seek sync code only in first frame, 1: seek sync code in every frame */
...
typedef enum _AX_VIN_TPG_COLOR_BAR_MODE_E_ {
    ISP_TPG_BAR_H_INC                   = 0,
    ISP_TPG_BAR_H_DEC                   = 1,
    ISP_TPG_BAR_V_INC                   = 2,
    ISP_TPG_BAR_V_DEC                   = 3,
    ISP_TPG_BAR_VG                      = 4,
    ISP_TPG_BAR_PURE_RED                = 5,
    ISP_TPG_BAR_PURE_GREEN              = 6,
    ISP_TPG_BAR_PURE_BLUE               = 7,
} AX_VIN_TPG_COLOR_BAR_MODE_E;

typedef struct _AX_VIN_DEV_TPG_ATTR_T_ {
    AX_U32                                  nFrmTriggerNum; /*0 means continue */
    AX_U32                                  nFrmRate;
    AX_VIN_TPG_COLOR_BAR_MODE_E             eColorBarMode;
} AX_VIN_DEV_TPG_ATTR_T;

typedef enum _AX_SNS_INTF_TYPE_E_ {
...
typedef struct _AX_VIN_DEV_ATTR_T_ {
    ...
    AX_U32                                  nRealWidth;     /*sensor output real width*/
    AX_U32                                  nRealHeight;    /*sensor output real height*/
    ...
    union {
        ...
        AX_VIN_DEV_TPG_ATTR_T               tTpgIntfAttr;       /* input interface attr: TPG */
    };
} AX_VIN_DEV_ATTR_T;

typedef enum _AX_PRIVATE_DATA_MODE_E_ {
...
typedef struct _AX_VIN_DEV_STATUS_T_ {
    AX_BOOL                     bEnable;
    AX_U64                      nIntCnt;
    AX_U64                      nFrameSeqNum;
    AX_F32                      fFrameRate;
...
typedef struct _AX_VIN_PIPE_STATUS_T_ {
    AX_BOOL                     bEnable;
    AX_U64                      nIntCnt;
    AX_U64                      nFrameSeqNum;
    AX_F32                      fFrameRate;
...
typedef struct _AX_VIN_CHN_STATUS_T_ {
    AX_BOOL                     bEnable;
    AX_U64                      nIntCnt;
    AX_U64                      nFrameSeqNum;
    AX_F32                      fFrameRate;
...
typedef struct _AX_VIN_CHN_ATTR_T_ {
    ...
    AX_U32                      nDepth;
    AX_FRAME_COMPRESS_INFO_T    tCompressInfo;  /* lossless: u32CompressLevel = 0;lossy: 8bitmode [1,10] or [AX_COMPRESS_Y12_5_UV12_5,AX_COMPRESS_Y75_UV50],10bitmode [1,10]*/
    AX_FRAME_RATE_CTRL_T        tFrameRateCtrl;
} AX_VIN_CHN_ATTR_T;
...
typedef struct _AX_VIN_CROP_INFO_T_ {
    AX_BOOL bEnable;
    AX_VIN_COORD_E eCoordMode;
    AX_WIN_AREA_T tCropRect;
} AX_VIN_CROP_INFO_T;

typedef enum _AX_VIN_DOWN_SCALE_RATIO_E_ {
    AX_VIN_DOWN_SCALE_RATIO_1X  = 0,
    AX_VIN_DOWN_SCALE_RATIO_2X  = 1,
    AX_VIN_DOWN_SCALE_RATIO_4X  = 2,
    AX_VIN_DOWN_SCALE_RATIO_8X  = 3,
    AX_VIN_DOWN_SCALE_RATIO_16X = 4,
    AX_VIN_DOWN_SCALE_RATIO_32X = 5,
    AX_VIN_DOWN_SCALE_RATIO_64X = 6,
...
typedef struct {
    AX_U8                     bEnable; /* fast boot en */
    AX_U8                     nRtosFrameNum; /* RTOS cached frame num */
    AX_U8                     bRtosStop;     /* RTOS Pipe stop*/
    AX_U8                     bRtosShutDown; /* RTOS shutdown */
    AX_U8                     bLinuxTakeOver; /* linux Takeover completion，RTOS's cached frame has been processed */
} AX_VIN_PIPE_FAST_STATUS_T;

typedef struct _AX_PIPE_TDM_T_ {
    AX_U8 nPipeId;
    AX_U8 nProcIdx;
} AX_PIPE_TDM_T;

typedef struct _AX_VIN_TDM_GRP_ATTR_T_ {
    AX_U8 nPipeNum;
    AX_PIPE_TDM_T tPipeTdm[AX_VIN_TDM_MAX_PIPE_NUM];
} AX_VIN_TDM_GRP_ATTR_T;
...
AX_S32 AX_VIN_SetLowMemMode(AX_U32 uMode);
AX_S32 AX_VIN_GetLowMemMode(AX_U32 *uMode);
AX_S32 AX_VIN_SetPoolAttr(const AX_POOL_FLOORPLAN_T *pPoolFloorPlan);

AX_S32 AX_VIN_SetLatencyMode(AX_VIN_LATENCY_MODE_E eMode);
AX_S32 AX_VIN_GetLatencyMode(AX_VIN_LATENCY_MODE_E *eMode);
...
AX_S32 AX_VIN_SetTdmGrpAttr(const AX_VIN_TDM_GRP_ATTR_T *pstTdmGrpAttr);
AX_S32 AX_VIN_GetTdmGrpAttr(AX_VIN_TDM_GRP_ATTR_T *pstTdmGrpAttr);
...
AX_S32 AX_VIN_QueryFastBootStatus(AX_U8 nPipeId, AX_VIN_PIPE_FAST_STATUS_T *pStatus);
#ifdef __cplusplus
}
#endif
