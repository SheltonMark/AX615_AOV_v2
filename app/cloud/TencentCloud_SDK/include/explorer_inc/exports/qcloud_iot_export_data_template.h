...
typedef struct {
    ...
    uint32_t mqtt_ping_interval_ms;   // MQTT ping packat send interval
...
#define DEFAULT_TEMPLATE_INIT_PARAMS                                            \
    {                                                                           \
        "china", NULL, NULL, NULL, NULL, 2000, 240 * 1000, 0, QCLOUD_IOT_MQTT_RX_BUF_LEN, QCLOUD_IOT_MQTT_TX_BUF_LEN, 1, 1, \
        {                                                                       \
            0                                                                   \
        }                                                                       \
    }
...
#define DEFAULT_TEMPLATE_INIT_PARAMS                                      \
    {                                                                     \
        "china", NULL, NULL, NULL, 2000, 240 * 1000, 0, QCLOUD_IOT_MQTT_RX_BUF_LEN, QCLOUD_IOT_MQTT_TX_BUF_LEN, 1, 1, \
        {                                                                 \
            0                                                             \
        }                                                                 \
    }
