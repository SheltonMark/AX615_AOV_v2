 ...
 *
 * @param pClient           MQTTClient pointer
 * @param pDevInfo          dev info
 * @param usrArg            usr arg to return the target resource
 * @return                  QCLOUD_RET_SUCCESS for success
 *                          otherwise, failure
 */
int IOT_Get_Ntp_Time(void *pClient, DeviceInfo *pDevInfo, void *usrArg);
 ...
 *                          otherwise, failure
 */
int IOT_Sync_NtpTime(void *pClient, DeviceInfo *pDevInfo, void *usrArg);

char *IOT_Get_MQTTAddr(void *pClient);
